...
Revision ID: c25b1e6dab84
Revises: 
Create Date: 2023-09-01 14:50:51.787069
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('loaded', 'markingup', 'markup', 'approving', 'approve', 'failed', name='documentstatus'), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
...
#    op.create_index('idx_location_geometry', 'location', ['geometry'], unique=False, postgresql_using='gist')
    ...
    sa.Column('file_connections', sa.LargeBinary(), nullable=True),
